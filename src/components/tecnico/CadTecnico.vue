            ...
            <form class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-check form-check-inline">
                        ...
                        value="1" @click="ativo = true" checked/>
                        <label class="form-check-label" for="inlineRadio1">Ativo</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" 
                        value="0" @click="ativo = false"/>
                        <label class="form-check-label" for="inlineRadio2">Inativo</label>
                    </div>
                </div>
                <div class="col-12 mt-5">
                    <button :disabled="noNome || shortNome || shortTelefone" type="submit"
                    class="btn btn-red">Cadastrar Técnico</button>
